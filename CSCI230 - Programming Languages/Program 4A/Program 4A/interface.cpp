...
// 8. Calcualte
void Interface::calculate(string rawExpressionString, expVector infixExp, expVector &postfixExp, floatVarValueTable &varTable, float &expValue)
{
...
void Interface::startInterface() {
    ...
    while ( inMenu )
    {
        ...
        cout << "C. [Calculation]  Evaluate whatever arithmetic or logic expression" << endl;
        ...
        switch (keyPressed) {
            ...
            case 'C': case 'c':
                cout << "[calculator option]: " << endl;
                calculate(rawExpressionString, infixExp, postfixExp, varTable, expValue);
