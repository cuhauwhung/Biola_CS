...
int main()
{
	...
	while ( inMenu )
	{
        ...
        cout << "************************************************" <<endl<< endl;
        cout<<"L. Brute force method" << endl;
        cout<<"R. Recover an unknown message (once)" << endl;
        cout<<"T. Recover an unknown message (twice)" << endl;
        cout<<"U. Checking the precision" << endl;
...
//				}
        ...
        case 'L': case 'l'://
            {
                ...
                cout << "What is the observed corrupted document?" << endl;
                cin >> corrupt;
                bruteForceMethod(actual, corrupt);
                break;
            }
                
        case 'R': case'r':
            {
                string vocabularyFile="vocabulary.txt", corruptedFile1="corruptedMessage1.txt";
                optionR(vocabularyFile, corruptedFile1);
        ...
        case'T': case't':
            {
                string vocabularyFile="vocabulary.txt", corruptedFile1="corruptedMessage1.txt", corruptedFile2="corruptedMessage2.txt"
                ;
                optionT(vocabularyFile, corruptedFile1, corruptedFile2);
                break;
            }
                
        case 'U': case'u':
            {
                string recovered1="recoveredMessage_V1.txt", recovered2="recoveredMessage_V2.txt", original="MessageX.txt";
                optionU(original, recovered1, recovered2);
                break;
            }
