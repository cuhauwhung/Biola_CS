...
double bruteForceMethod(string document1, string document2);
double optionR(string document1, string document2);
double optionT(string document1, string document2, string document3);
double optionU(string document1, string document2, string document3);
